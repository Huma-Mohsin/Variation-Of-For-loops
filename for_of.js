...
let country = ["Pakistan", "America", "China", "Turkey", "Switzerland", "Australia"];
...
let guests = ["Ali", "Sara", "Zahid", "Kainat", "Zimmal", "Zain"];
...
console.log("\n*** Using Continue And Break***\n");
let guests2 = ["Ali", "Sara", "Zahid", "Kainat", "Zimmal", "Zain"];
